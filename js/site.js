/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__enable_chapters__ =
        __webpack_require__(2);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modal__ =
      ...
      window.onload = () => {
        Object(
          __WEBPACK_IMPORTED_MODULE_1__enable_chapters__["a" /* default */]
        )();
        fade();
        parallaxFade();
        Object(__WEBPACK_IMPORTED_MODULE_2__modal__["a" /* default */])();
      };

      window.showNav = () => {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("nav").addClass(ACTIVE);
      };

      window.hideNav = () => {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("nav").removeClass(
          ACTIVE
        );
      };

      //Fade In for each article. no parallax
      function fade() {
        const $con = document.querySelectorAll("section.chapter");
        ...
        $con.forEach((content) => {
          new Waypoint({
            ...
            handler: function (direction) {
              var $content =
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(content);
              if (direction === "down") {
      ...
      //Fade in and out of parallax background image
      function parallaxFade() {
        const $parallax = document.querySelectorAll("div.parallax");
        ...
        $parallax.forEach((parallax) => {
          new Waypoint({
            ...
            handler: function (direction) {
              let $parallax =
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(parallax);
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      //Selected Text changing and scroll.
      function enableChapters() {
        ...
        chapters.forEach((chapter) => {
          new Waypoint({
            ...
            handler: () => {
              const $chapter =
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(chapter);
              const title = $chapter.data("title");

              document.getElementById("Marker").innerHTML = title;
              document.title = title;
              window.history.pushState({}, title, "#" + $chapter[0].id);
            },
          });
        });
      }
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      "use strict";
      /* harmony export (immutable) */ __webpack_exports__["a"] = imgGallery;
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ =
        __webpack_require__(0);
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default =
        __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
      ...
      function imgGallery() {
        ...
        imgSelect.forEach((imgEl) => {
          imgEl.addEventListener("click", (evt) => {
            ...
            captionText.innerHTML = currentTarget.alt;
